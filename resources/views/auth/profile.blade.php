...
<main style="display: flex; justify-content: center; align-items: center; min-height: 80vh; background-color: #f0f2f5; padding: 20px; font-family: sans-serif;">
    ...
    <div style="background: white; width: 100%; max-width: 450px; padding: 40px; border-radius: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); text-align: center;">
        ...
        <h2 style="margin-bottom: 25px; color: #333;">{{ __('messages.my_profile') }}</h2>
        ...
        <form action="/profile" method="POST" enctype="multipart/form-data">
            ...
            <div style="position: relative; display: inline-block; margin-bottom: 20px;">
                ...
                <label for="avatar-input" style="position: absolute; bottom: 5px; right: 5px; background: #007bff; color: white; width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; border: 2px solid white; font-size: 20px;" title="{{ __('messages.change_img') }}">
                    +
                </label>
            ...
            <div style="margin-bottom: 20px; text-align: left;">
                <label style="display: block; margin-bottom: 8px; color: #555; font-weight: bold; font-size: 14px;">{{ __('messages.full_name') }}</label>
            ...
            <div style="margin-bottom: 30px; text-align: left;">
                <label style="display: block; margin-bottom: 8px; color: #555; font-weight: bold; font-size: 14px;">{{ __('messages.email') }}</label>
